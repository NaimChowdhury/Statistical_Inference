...
fl_crime <- fl_crime %>% rename(crime = `crime rate (per 1000)`) %>% rename(education = `education (%)`)
...
Is there a statistically significant relationship? Interpret the resulting effect of education on crime.

...
### 3a.
x's are fixed, betas are constants, errors follow normal distribution with mean 0 and var sig^2
...
This corresponds to a Type I error. We rejected $H_0$, even though $H_0$ is true. When you conduct $t$-tests a certain number of times, we are bound to get Type I errors. Approximately for $\alpha = 0.05$, we get 5% Type I errors.
...
This seems to indicate that the way in which the data was generated was not truly random.

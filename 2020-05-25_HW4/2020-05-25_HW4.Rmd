...
Xsq <- chisq.test(dedi.chis)$statistic
...
points(x = chiquant, y = c(0,0), pch = 'X', col = 'blue')
```
The observed $X^2$ for this particular experiment is particularly high, at $X^2 = 1901$. This is well outside of the 95% confidence interval. We can conclude by rejecting the null hypothesis, that is, we reject the hypothesis that the variables Dedicated and SLI_Crossfire are independent.
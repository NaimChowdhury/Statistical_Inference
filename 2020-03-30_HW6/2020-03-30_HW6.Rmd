...
```
  ...
  5. The RSE is 4.265, which is relatively small. We can conclude that our model is a decent fit for the data.
  
  6. The $R^2$ value is 0.332, which is closer to 0 than 1. We can conclude that our model is a decent fit for the data.

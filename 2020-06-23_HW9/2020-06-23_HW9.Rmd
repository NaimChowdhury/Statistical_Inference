...
## Part 2.
  ...
  1) The full modeling equation is:
...
$$sales_{NA,i} = \beta_0 + \beta_2 + (\beta_1 + \beta_5) sales_{JP,i} + \epsilon_i, \ \ \epsilon \sim_{i.i.d} N(0, \sigma^2.$$

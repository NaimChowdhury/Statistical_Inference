...
$$\widehat{sales}_{NA,i} = 0.19277, + (2.09296,) sales_{JP,i} + \epsilon_i, \ \ \epsilon \sim_{i.i.d} N(0, \sigma^2$$

and when the genre is _Role Playing_
  
$$\widehat{sales}_{NA,i} = \beta_0 + \beta_3 + (\beta_1 + \beta_5) sales_{JP,i} + \epsilon_i, \ \ \epsilon \sim_{i.i.d} N(0, \sigma^2.$$
